...
@section('title') Listado de géneros @endsection
@section('content')
<a href="generos/create" class="btn btn-primary">Género Nuevo</a>
<table class="table table-striped table-bordered">
    ...
    <tr>
        <td><a href="./generos/{{$genero->id}}">{{$genero->nombre}}</a></td>
        <td>
            <ul class="list-group list-group-horizontal" style="list-style-type:none">
                <li class="list-item" style="margin-right: 10px;">
                    <a href="generos/{{$genero->id}}/edit" class="btn btn-warning"><svg width="1em" height="1em"
...
<script>
    function borrar() {
        return confirm("Está seguro de borrar el género?");
    }
</script>
@endsection